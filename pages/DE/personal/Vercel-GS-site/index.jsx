...
export default function functionEN() {
    ...
    return (
      ...
      <div className="container-div">
        ...
        <PersonalHeaderEN/>
        <br />
        <h2 className="Main-h2">Vercel, Persönliche Webseite:</h2>
        <button className='Button'><a target="_blank" rel="noopener noreferrer"   href="https://ibzspsrprod-gavin.vercel.app/EN">Link </a></button>
        ...
        Stand ab 10/01/23 (DD/MM/YY): Online
         ...
         <br/>
         Domain: https://ibzspsrprod-gavin.vercel.app/
        </p>
      </div>
    );
  }